...
<div class="tabs">
    <ul class="tab-links">
        ...
        <li class="active"><a href="<?php print './' . $node->nid . '?tournament_id=' . $tournament_data['id'] . '&type=competition&view=without_result' ?>">Без результатов игр</a></li>
...
<table class="table-tournament sortable">
    ...
    <?php foreach ($tournament_data['team_stats'] as $key => $team_stat): ?>
        <tr>
            ...
            <td><?php print $team_stat['score_for'] ?></td>
            <td><?php print $team_stat['score_against'] ?></td>
