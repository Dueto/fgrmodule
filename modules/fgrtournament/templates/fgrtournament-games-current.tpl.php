...
<div class="tabs">
    <ul class="tab-links">
        <li class="active"><a href="<?php print './' . $node->nid . '?tournament_id=' . $tournament_data['TournamentMetaData']['TournamentId'] . '&type=games&game_type=online&crumbs=' . $crumb_string ?>">Текущие</a></li>
...
<table class="table_games sortable">
    ...
    <?php foreach ($tournament_data['Data'] as $key => $game): ?>
        <tr>
            ...
            <td class="left">
                <img class="team_icon" src="<?php if($game['Game']['GameTeam2']['CompTeam']['Team']['ClubLogoId']) print variable_get('fgrtournament_system_url', 'http://fgr.ntrlab.ru:81/api') . '/Media/Image/' . $game['Game']['GameTeam2']['CompTeam']['Team']['ClubLogoId']; else print '../files/fgrmodule/logo.png'; ?>">
